				...
				<div class="col-md-9 col-sm-9" id="wrapper">
					<div class="feature-box">
			            <div class="bradcrumbs">
			                <?php multipurpose_startup_the_breadcrumb(); ?>
			            </div>
					</div>
					<?php while ( have_posts() ) : the_post(); ?>
						...
						if ( is_singular( 'attachment' ) ) {
							...
							the_post_navigation( array(
								'next_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Next', 'multipurpose-startup' ) . '</span> ' .
									'<span class="screen-reader-text">' . __( 'Next post:', 'multipurpose-startup' ) . '</span> ' .
									'<span class="post-title">%title</span>',
								'prev_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Previous', 'multipurpose-startup' ) . '</span> ' .
